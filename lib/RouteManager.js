...
RouteManager = (function(_super) {
  ...
  function RouteManager() {
    fs.ensureDir((app_root || '.') + "/views", (function(_this) {
      return function() {
        return fs.ensureDir((app_root || '.') + "/routes", function() {
  ...
  RouteManager.prototype.load = function(callback) {
    var e, _routes;
    try {
      _routes = this.getpaths((app_root || '.') + "/views");
    } catch (_error) {
      e = _error;
    ...
    if ((list = fs.readdirSync(dir)).length) {
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        if (stat != null ? stat.isDirectory() : void 0) {
          ...
          paths.push(this.getpaths("" + (app_root || '.') + _path.sep + file));
        } else {
          ...
          routeItem = {
            ...
            route: this.formatRoute(_path.join(dir.replace(/\/?views+/, ''), itemName))
          };
