...
var EventEmitter, RouteManager, fs, path, _,
...
RouteManager = (function(_super) {
  ...
  RouteManager.prototype.getRoute = function() {};

  RouteManager.prototype.createRoute = function() {};

  RouteManager.prototype.destroyRoute = function() {};
  ...
  RouteManager.prototype.createRoute = function(path) {
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        if (stat != null ? stat.isDirectory() : void 0) {
          ...
          routeItem = {
            ...
            route: this.createRoute(path.join(dir.replace(/\/?views+/, ''), itemName))
          };
